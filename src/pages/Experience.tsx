...
export const Experience = () => {
    return (
        <div>
            ...
            <div>
                <CardCustom title={'Mevivu Technology'}
                            desc={'Developed scalable websites and APIs with Laravel, built custom WordPress e-commerce sites, and managed web hosting with DirectAdmin.' +
                                ' Worked closely with frontend developers and business analysts to enhance user experience and project efficiency.'}
                            link={'/experience/mevivu'} date={'23/10/2023 - 26/11/2024'}/>
