            ...
            <div className='group cursor-pointer animate-fade-down flex flex-row items-start relative theme-card hover:bg-green-custom w-full rounded-lg p-3 transition-all duration-500 my-[5rem]'>
                <div>
                    <h1 className='font-bold text-4xl sm:text-5xl md:text-6xl my-5 theme-text'>
                        Let's<br />
                        <span className='text-green-custom group-hover:text-gray-800 dark:group-hover:text-white transition-all duration-500'>
                            collaborate
                        </span>
                    </h1>
                    <div>
                        <p className="theme-text-secondary group-hover:text-gray-800 dark:group-hover:text-white transition-all duration-500">
